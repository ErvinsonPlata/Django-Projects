...
SECRET_KEY = "django-insecure-bk(jg9#65xo@j*2o-nok*yippyox^xj&1^(ks(l$4_3&q97p0&"
...
DATABASES = {
    ...
    #'NAME': 'postgres',
    #'HOST': 'db-django.cn0ess22s7zi.us-east-2.rds.amazonaws.com',
    #'PORT': '5432',
    #'USER':env.str('DJANGO_DB_USER'),
    #'PASSWORD': env.str('DJANGO_DB_PASSWORD'),
    # postgres://USER:PASSWORD@HOST:PORT/NAME Formato para el env.db()
}
